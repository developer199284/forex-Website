        ...
        [
            ...
            },
            {
                ...
                template: function(row){
                    return getJustDateWIthYear(row.boost_date);
                },
            },
            {
                field: 'bought_date',
                ...
                template: function(row){
                    return getJustDateWIthYear(row.bought_date);
                },
            },
            {
                field: 'boost_completion',
                title: lang.users_tbl_boostcompletion,
                template: function(row){
                    return getJustDateWIthYear(row.boost_completion);
                },
            },{
                field: 'Actions',
                ...
                template: function(row) {
                    ...
                    '<a onclick="javascript:confirm(\'Are you sure want to delete '+row.uniqueId+'?\')?deleteUser('+row.id+'):\'\';" class="btn btn-sm btn-clean btn-icon mr-2" title="Reset password">\
